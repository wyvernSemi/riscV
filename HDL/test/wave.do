...
add wave -noupdate -group alu /tb/uut/rv32i_cpu_core_inst/alu/a_rs_idx
...
add wave -noupdate -group alu /tb/uut/rv32i_cpu_core_inst/alu/rd
...
WaveRestoreCursors {{Cursor 1} {1168800145 ps} 0} {{Cursor 2} {2150000 ps} 0}
...
update
WaveRestoreZoom {2078023 ps} {2179320 ps}
