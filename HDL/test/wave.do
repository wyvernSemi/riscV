...
add wave -noupdate -expand -group core /tb/uut/MEM_BIT_WIDTH
add wave -noupdate -expand -group core /tb/uut/RV32I_DMEM_ADDR_WIDTH
add wave -noupdate -expand -group core /tb/uut/RV32I_IMEM_ADDR_WIDTH
add wave -noupdate -expand -group core -radix ascii /tb/uut/RV32I_IMEM_INIT_FILE
add wave -noupdate -expand -group core /tb/uut/RV32I_LOG2_REGFILE_ENTRIES
add wave -noupdate -expand -group core /tb/uut/RV32I_REGFILE_USE_MEM
add wave -noupdate -expand -group core -radix hexadecimal /tb/uut/RV32I_RESET_VECTOR
add wave -noupdate -expand -group core -radix hexadecimal /tb/uut/RV32I_TRAP_VECTOR
add wave -noupdate -expand -group core /tb/uut/CLK_FREQ_MHZ
add wave -noupdate -expand -group core /tb/uut/clk
add wave -noupdate -expand -group core /tb/uut/reset_n
add wave -noupdate -expand -group core /tb/uut/core_rstn
add wave -noupdate -expand -group core /tb/uut/count
add wave -noupdate -expand -group core /tb/uut/avs_csr_address
add wave -noupdate -expand -group core /tb/uut/avs_csr_read
add wave -noupdate -expand -group core /tb/uut/avs_csr_readdata
add wave -noupdate -expand -group core /tb/uut/avs_csr_write
add wave -noupdate -expand -group core /tb/uut/avs_csr_writedata
add wave -noupdate -expand -group core -radix hexadecimal /tb/uut/dmem_addr
add wave -noupdate -expand -group core /tb/uut/dmem_be
add wave -noupdate -expand -group core /tb/uut/dmem_rd
add wave -noupdate -expand -group core /tb/uut/dmem_rd_delay
add wave -noupdate -expand -group core -radix hexadecimal /tb/uut/dmem_rdata
add wave -noupdate -expand -group core /tb/uut/dmem_read
add wave -noupdate -expand -group core /tb/uut/dmem_waitreq
add wave -noupdate -expand -group core -radix hexadecimal /tb/uut/dmem_wdata
add wave -noupdate -expand -group core /tb/uut/dmem_wr
add wave -noupdate -expand -group core /tb/uut/dmem_write
add wave -noupdate -expand -group core -radix hexadecimal /tb/uut/imem_raddr
add wave -noupdate -expand -group core /tb/uut/imem_rd
add wave -noupdate -expand -group core -radix hexadecimal /tb/uut/imem_rdata
add wave -noupdate -expand -group core /tb/uut/imem_read
add wave -noupdate -expand -group core -radix hexadecimal /tb/uut/imem_readdata
add wave -noupdate -expand -group core /tb/uut/imem_readdatavalid
add wave -noupdate -expand -group core -radix hexadecimal /tb/uut/imem_waddr
add wave -noupdate -expand -group core -radix hexadecimal /tb/uut/imem_wdata
add wave -noupdate -expand -group core /tb/uut/imem_write
add wave -noupdate -expand -group core /tb/uut/imem_be
add wave -noupdate -expand -group core /tb/uut/led
add wave -noupdate -expand -group core /tb/uut/local_read
add wave -noupdate -expand -group core /tb/uut/local_readdata
add wave -noupdate -expand -group core /tb/uut/local_write
add wave -noupdate -expand -group core -radix hexadecimal /tb/uut/scratch
...
update
WaveRestoreZoom {2475063 ps} {2806576 ps}
